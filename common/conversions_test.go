...
func wordsEqual(a1 []uint64, a2 []uint64) bool {
	if len(a1) != len(a2) {
		return false
	}
...
func Test_Word36ToByteArrayPacked_2(t *testing.T) {
	source := []uint64{0, 0_111222_333444, 0_555666777000, 0}
...
func Test_Word36ToByteArrayPacked_3(t *testing.T) {
	source := []uint64{0, 0_444444_444444, 0}
...
func Test_ByteArrayPackedToWord36(t *testing.T) {
	...
	expected := []uint64{0_104315_042526, 0_316742_114652}
	destination := make([]uint64, 28)
...
func Test_Word36ToByteArray8Bit_1(t *testing.T) {
	source := []uint64{0_777_777_777_777, 0_012_345_234_567}
...
func Test_ByteArray8BitToWord36(t *testing.T) {
	...
	expected := []uint64{0_000000_042063, 0_104125_146167, 0_210231_252273, 0_314000_000000}
	destination := make([]uint64, 28)
...
func Test_Word36ToByteArray6Bit_1(t *testing.T) {
	source := []uint64{0_77_77_77_33_11_00, 0_01_23_45_23_45_67}
...
func Test_ByteArray6BitToWord36(t *testing.T) {
	...
	expected := []uint64{0_000042_630425, 0_466717_700000}
	destination := make([]uint64, 28)
