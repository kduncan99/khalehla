...
func updateDesignatorRegister(e *InstructionEngine, addend1Positive bool, addend2Positive bool, sumPositive bool) {
	...
	if dr.IsOperationTrapEnabled() && db19 {
		i := common.NewOperationTrapInterrupt(common.OperationTrapFixedPointBinaryOverflow)
		e.PostInterrupt(i)
	}
}
...
func AddAccumulator(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		sum := common.AddSimple(addend1, addend2)
		aReg.SetW(sum)
		updateDesignatorRegister(e, common.IsPositive(addend1), common.IsPositive(addend2), common.IsPositive(sum))
	}
...
func AddNegativeAccumulator(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		aReg := e.GetExecOrUserARegister(ci.GetA())
		addend1 := aReg.GetW()
		addend2 := common.Negate(result.operand)
		sum := common.AddSimple(addend1, addend2)
		aReg.SetW(sum)
		updateDesignatorRegister(e, common.IsPositive(addend1), common.IsPositive(addend2), common.IsPositive(sum))
	}
...
func MultiplyInteger(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		aReg0 := e.GetExecOrUserARegister(ci.GetA())
		aReg1 := e.GetExecOrUserARegister(ci.GetA() + 1)
		res72 := common.Multiply(aReg0.GetW(), result.operand)
		if common.IsNegativeDouble(res72) {
...
func MultiplySingleInteger(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		ci := e.GetCurrentInstruction()
		aReg := e.GetExecOrUserARegister(ci.GetA())
		res72 := common.Multiply(aReg.GetW(), result.operand)
		aReg.SetW(res72[1])
		...
		if !okay {
			...
			if dr.IsOperationTrapEnabled() {
				i := common.NewOperationTrapInterrupt(common.OperationTrapMultiplySingleIntegerOverflow)
				e.PostInterrupt(i)
			}
		}
	}
...
func MultiplyFractional(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		res72 = common.LeftDoubleShiftCircular(res72, 1)
		aReg0.SetW(res72[0])
		aReg1.SetW(res72[1])
	}
...
var divCheck = common.NewArithmeticExceptionInterrupt(common.ArithmeticExceptionDivideCheck)
...
func DivideInteger(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		quotient, remainder, divByZero, overflow := common.Divide(dividend, divisor)
		if divByZero || overflow {
			e.PostInterrupt(divCheck)
			return false
		}

		divIsNegative := common.IsNegativeDouble(dividend)
		if divIsNegative != common.IsNegative(divisor) {
			quotient = common.Negate(quotient)
		}
		if divIsNegative != common.IsNegative(remainder) {
			remainder = common.Negate(remainder)
		}
...
func DivideSingleFractional(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		dividend := []uint64{aReg0.GetW(), signBitLookup[common.IsNegative(aReg0.GetW())]}
		dividend = common.RightDoubleShiftAlgebraic(dividend, 1)
		if (divisor == 0) || (aReg0.GetW() > common.Magnitude(divisor)) {
			e.PostInterrupt(divCheck)
			return false
		}

		quotient, _, _, _ := common.Divide(dividend, divisor)
		if common.IsNegativeDouble(dividend) != common.IsNegative(divisor) {
			quotient = common.Negate(quotient)
		}
...
func DoubleAddAccumulator(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		sum := common.AddDouble(addend1, addend2)
		aReg0.SetW(sum[0])
		aReg1.SetW(sum[1])
		updateDesignatorRegister(e, common.IsPositiveDouble(addend1), common.IsPositiveDouble(addend2), common.IsPositiveDouble(sum))
	}
...
func DoubleAddNegativeAccumulator(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		addend1 := []uint64{aReg0.GetW(), aReg1.GetW()}
		addend2 := common.NegateDouble([]uint64{result.source[0].GetW(), result.source[1].GetW()})
		sum := common.AddDouble(addend1, addend2)
		aReg0.SetW(sum[0])
		aReg1.SetW(sum[1])
		updateDesignatorRegister(e, common.IsPositiveDouble(addend1), common.IsPositiveDouble(addend2), common.IsPositiveDouble(sum))
...
func AddHalves(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		sumH1 := common.AddSimple(add1H1, add2H1)
		if sumH1 > 0_777777 {
		...
		sumH2 := common.AddSimple(add1H2, add2H2)
		if sumH2 > 0_777777 {
...
func AddNegativeHalves(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		add1H1 := aReg.GetXH1()
		add2H1 := common.Negate(result.source.GetXH1())
		sumH1 := common.AddSimple(add1H1, add2H1)
		if sumH1 > 0_777777 {
			sumH1 = (sumH1 & 0_777777) + 1
		}
		...
		add1H2 := aReg.GetXH2()
		add2H2 := common.Negate(result.source.GetXH2())
		sumH2 := common.AddSimple(add1H2, add2H2)
		if sumH2 > 0_777777 {
...
func AddThirds(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		sumT1 := common.AddSimple(add1T1, add2T1)
		if sumT1 > 0_7777 {
		...
		sumT2 := common.AddSimple(add1T2, add2T2)
		if sumT2 > 0_7777 {
		...
		sumT3 := common.AddSimple(add1T3, add2T3)
		if sumT3 > 0_7777 {
...
func AddNegativeThirds(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		add1T1 := aReg.GetXT1()
		add2T1 := common.Negate(result.source.GetXT1())
		sumT1 := common.AddSimple(add1T1, add2T1)
		if sumT1 > 0_7777 {
			sumT1 = (sumT1 & 0_7777) + 1
		}
		...
		add1T2 := aReg.GetXT2()
		add2T2 := common.Negate(result.source.GetXT2())
		sumT2 := common.AddSimple(add1T2, add2T2)
		if sumT2 > 0_7777 {
			sumT2 = (sumT2 & 0_7777) + 1
		}
		...
		add1T3 := aReg.GetXT3()
		add2T3 := common.Negate(result.source.GetXT3())
		sumT3 := common.AddSimple(add1T3, add2T3)
		if sumT3 > 0_7777 {
			sumT3 = (sumT3 & 0_7777) + 1
		}
