...
func aaSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func anaSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func amaSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func anmaSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func auSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func anuSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func axSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func anxSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func miSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func msiSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func mfSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func diSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func dsfSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func dfSourceItemU(j uint64, a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func daSourceItemU(a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func danSourceItemU(a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func ahSourceItemU(a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func anhSourceItemU(a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func atSourceItemU(a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func antSourceItemU(a uint64, x uint64, u uint64) *tasm.SourceItem {
...
func Test_AA_Basic(t *testing.T) {
	...
	checkRegister(t, engine, common.A2, 0_700212_275071)
}
...
func Test_ANA_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A2, 0_000344_070550)
}
...
func Test_AMA_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A2, 0_075160_022403)
}
...
func Test_ANMA_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A2, 0_245561_654555)
}
...
func Test_ANU_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A2, 0_000000_372117)
	checkRegister(t, engine, common.A3, 0_277404_252116)
}
...
func Test_AX_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.X2, 0_700212_275071)
}
...
func Test_ANX_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.X2, 0_000344_070550)
}
...
func Test_MI_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A2, 0_000000_000000)
	checkRegister(t, engine, common.A3, 0_115624_561516)
}
...
func Test_MSI_Overflow(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkInterruptAndSSF(t, engine, common.OperationTrapInterruptClass, common.OperationTrapMultiplySingleIntegerOverflow)
}
...
func Test_MSI_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A4, 0_000000_015012)
}
...
func Test_MF_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A3, 0_044444_444445)
	checkRegister(t, engine, common.A4, 0_044444_444444)
}
...
func Test_DI_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A2, 0_005213_747442)
	checkRegister(t, engine, common.A3, 0_000000_244613)
}
...
var diCodeDivideCheck = []*tasm.SourceItem{
	...
	diSourceItemHIBRef(jW, 2, 0, 0, 0, 0, grsRef(common.A10)),
	iarSourceItem(1),
...
func Test_DI_DivideCheck(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkInterruptAndSSF(t, engine, common.ArithmeticExceptionInterruptClass, common.ArithmeticExceptionDivideCheck)
	checkRegister(t, engine, common.A2, 0_000001_612175)
	checkRegister(t, engine, common.A3, 0_437777_700000)
}
...
func Test_DSF_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A3, 0_000000_007236)
	checkRegister(t, engine, common.A4, 0_001733_765274)
}
...
func Test_DF_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A4, 0_000000_021653)
	checkRegister(t, engine, common.A5, 0_000000_000056)
}
...
func Test_DA_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A4, 0_123012_342553)
	checkRegister(t, engine, common.A5, 0_056323_321126)
}
...
func Test_DAN_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A4, 0_000000_113110)
	checkRegister(t, engine, common.A5, 0_210014_413002)
}
...
func Test_AH_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A5, 0_000124_000124)
}
