...
func Test_LA_Basic(t *testing.T) {
	...
	checkRegister(t, engine, common.A0, 0123)
	checkRegister(t, engine, common.A1, 0_010203_040506)
	checkRegister(t, engine, common.A2, 0102)
	checkRegister(t, engine, common.A3, 07777)
}
...
func Test_LMA_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A0, 0_377777)
	checkRegister(t, engine, common.A1, 0_477777)
	checkRegister(t, engine, common.A2, 0_377777)
	checkRegister(t, engine, common.A3, 0_300000)
	checkRegister(t, engine, common.A4, 0_300000_123456)
	checkRegister(t, engine, common.A5, 0_377777_777776)
	checkRegister(t, engine, common.A6, 011)
	checkRegister(t, engine, common.A7, 044)
}
...
func Test_LNA_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.A0, 0_777777_400000)
	checkRegister(t, engine, common.A1, 0_777777_300000)
	checkRegister(t, engine, common.A2, 0_777777_400000)
	checkRegister(t, engine, common.A3, 0_300000)
	checkRegister(t, engine, common.A4, 0_477777_654321)
	checkRegister(t, engine, common.A5, 0_377777_777776)
	checkRegister(t, engine, common.A6, 011)
	checkRegister(t, engine, common.A7, 0_777777_777733)
}
...
func Test_LNMA_Extended(t *testing.T) {
	...
	checkRegister(t, engine, common.A1, 0_777777_300000)
	checkRegister(t, engine, common.A2, 0_777777_400000)
	checkRegister(t, engine, common.A3, 0_777777_477777)
	checkRegister(t, engine, common.A4, 0_477777_654321)
	checkRegister(t, engine, common.A5, 0_400000_000001)
	checkRegister(t, engine, common.A6, 0_777777_777766)
	checkRegister(t, engine, common.A7, 0_777777_777733)
}
...
func Test_LR_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.R7, 063)
	checkRegister(t, engine, common.R8, 040506)
}
...
func Test_LR_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.R4, 0_000000_040506)
	checkRegister(t, engine, common.R5, 0_777777_774000)
}
...
func Test_LX_Basic(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.X1, 0_377777)
	checkRegister(t, engine, common.X15, 0_112233_445566)
	checkRegister(t, engine, common.A3, 0_112233_445566)
}
...
func Test_LX_Extended(t *testing.T) {
	...
	engine := ute.GetEngine()
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, common.X1, 05)
}
...
func Test_DL_Basic(t *testing.T) {
	...
	checkRegister(t, engine, common.A4, 0_100200_300400)
	checkRegister(t, engine, common.A5, 0_500600_700777)
	checkRegister(t, engine, common.A0, 0_100200_300400)
	checkRegister(t, engine, common.A1, 0_500600_700777)
	checkRegister(t, engine, common.A2, 0_677577_477377)
	checkRegister(t, engine, common.A3, 0_277177_077000)
	checkRegister(t, engine, common.A6, 0_277177_077000)
	checkRegister(t, engine, common.A7, 0_777777_777772)
	checkRegister(t, engine, common.A10, 0_100200_300400)
	checkRegister(t, engine, common.A11, 0_500600_700777)
	checkRegister(t, engine, common.A12, 0_277177_077000)
	checkRegister(t, engine, common.A13, 0_777777_777772)
}
