...
func SingleShiftCircular(e *InstructionEngine) (completed bool) {
	...
	aReg.SetW(common.RightShiftCircular(aReg.GetW(), count))
	return true
}
...
func DoubleShiftCircular(e *InstructionEngine) (completed bool) {
	...
	result := common.RightDoubleShiftCircular(operand, count)
	aReg0.SetW(result[0])
	aReg1.SetW(result[1])
	return true
}
...
func SingleShiftLogical(e *InstructionEngine) (completed bool) {
	...
	ci := e.GetCurrentInstruction()
	aReg := e.GetExecOrUserARegister(ci.GetA())
	aReg.SetW(common.RightShiftLogical(aReg.GetW(), count))
	return true
}
...
func DoubleShiftLogical(e *InstructionEngine) (completed bool) {
	...
	aReg1 := e.GetExecOrUserARegister(ci.GetA() + 1)
	operand := []uint64{aReg0.GetW(), aReg1.GetW()}
	result := common.RightDoubleShiftLogical(operand, count)
	aReg0.SetW(result[0])
	aReg1.SetW(result[1])
	return true
}
...
func SingleShiftAlgebraic(e *InstructionEngine) (completed bool) {
	...
	ci := e.GetCurrentInstruction()
	aReg := e.GetExecOrUserARegister(ci.GetA())
	aReg.SetW(common.RightShiftAlgebraic(aReg.GetW(), count))
	return true
}
...
func DoubleShiftAlgebraic(e *InstructionEngine) (completed bool) {
	...
	aReg1 := e.GetExecOrUserARegister(ci.GetA() + 1)
	operand := []uint64{aReg0.GetW(), aReg1.GetW()}
	result := common.RightDoubleShiftAlgebraic(operand, count)
	aReg0.SetW(result[0])
	aReg1.SetW(result[1])
	return true
}
...
func LeftSingleShiftCircular(e *InstructionEngine) (completed bool) {
	...
	ci := e.GetCurrentInstruction()
	aReg := e.GetExecOrUserARegister(ci.GetA())
	aReg.SetW(common.LeftShiftCircular(aReg.GetW(), count))
	return true
}
...
func LeftDoubleShiftCircular(e *InstructionEngine) (completed bool) {
	...
	aReg1 := e.GetExecOrUserARegister(ci.GetA() + 1)
	operand := []uint64{aReg0.GetW(), aReg1.GetW()}
	result := common.LeftDoubleShiftCircular(operand, count)
	aReg0.SetW(result[0])
	aReg1.SetW(result[1])
	return true
}
...
func LeftSingleShiftLogical(e *InstructionEngine) (completed bool) {
	...
	ci := e.GetCurrentInstruction()
	aReg := e.GetExecOrUserARegister(ci.GetA())
	aReg.SetW(common.LeftShiftLogical(aReg.GetW(), count))
	return true
}
...
func LeftDoubleShiftLogical(e *InstructionEngine) (completed bool) {
	...
	aReg1 := e.GetExecOrUserARegister(ci.GetA() + 1)
	operand := []uint64{aReg0.GetW(), aReg1.GetW()}
	result := common.LeftDoubleShiftLogical(operand, count)
	aReg0.SetW(result[0])
	aReg1.SetW(result[1])
	return true
}
