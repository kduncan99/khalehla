...
func TestEvenParity(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.CountBits(value)&01 == 0 {
...
func TestOddParity(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		aReg := e.GetExecOrUserARegister(ci.GetA())
		value := result.operand & aReg.GetW()
		if common.CountBits(value)&01 == 01 {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestGreaterThanZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if result.operand != common.PositiveZero && common.IsPositive(result.operand) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestPositiveZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if result.operand == common.PositiveZero {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestPositive(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.IsPositive(result.operand) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestMinusZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if result.operand == common.NegativeZero {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestMinusZeroOrGreaterThanZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if result.operand == common.NegativeZero ||
			(result.operand != common.PositiveZero && common.IsPositive(result.operand)) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.IsZero(result.operand) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestNotLessThanZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.IsPositive(result.operand) && result.operand != common.PositiveZero {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestLessThanZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.IsNegative(result.operand) && result.operand != common.NegativeZero {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestPositiveZeroOrLessThanZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if (result.operand == common.PositiveZero) ||
			(common.IsNegative(result.operand) && result.operand != common.NegativeZero) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestNegative(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if !common.IsNegative(result.operand) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestNotGreaterThanZero(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.IsNegative(result.operand) || result.operand == common.PositiveZero {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestLessThanOrEqual(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		ci := e.GetCurrentInstruction()
		aValue := e.GetExecOrUserARegister(ci.GetA()).GetW()
		if common.Compare(result.operand, aValue) <= 0 {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestGreaterMagnitude(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		ci := e.GetCurrentInstruction()
		aValue := e.GetExecOrUserARegister(ci.GetA()).GetW()
		if common.Compare(common.Magnitude(result.operand), aValue) > 0 {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestWithinRange(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if common.Compare(common.Magnitude(result.operand), a1) > 0 &&
			common.Compare(common.Magnitude(result.operand), a2) <= 0 {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func MaskedTestEqual(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		ci := e.GetCurrentInstruction()
		aValue := e.GetExecOrUserARegister(ci.GetA()).GetW()
		rValue := e.GetExecOrUserRRegister(common.R2).GetW()
		if common.And(result.operand, rValue) == common.And(aValue, rValue) {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func MaskedTestLessThanOrEqual(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		aValue := e.GetExecOrUserARegister(ci.GetA()).GetW()
		rValue := e.GetExecOrUserRRegister(common.R2).GetW()
		if common.Compare(common.And(result.operand, rValue), common.And(aValue, rValue)) <= 0 {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func MaskedTestWithinRange(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		ci := e.GetCurrentInstruction()
		ax := e.GetExecOrUserARegisterIndex(ci.GetA())
		rVal := e.GetExecOrUserRRegister(common.R2).GetW()
		a1Masked := common.And(e.GetExecOrUserARegister(ax).GetW(), rVal)
		a2Masked := common.And(e.GetExecOrUserARegister(ax+1).GetW(), rVal)
		opMasked := common.And(result.operand, rVal)

		if common.Compare(common.Magnitude(opMasked), a1Masked) > 0 &&
			common.Compare(common.Magnitude(opMasked), a2Masked) <= 0 {
			pc := e.GetProgramAddressRegister().GetProgramCounter()
			e.SetProgramCounter(pc+2, true)
		}
	}
...
func TestAndSet(e *InstructionEngine) (completed bool) {
	...
	if result.interrupt != nil {
		...
		if result.source.GetW()&0_010000_0000 != 0 {
			i := common.NewTestAndSetInterrupt(result.sourceBaseRegisterIndex, result.sourceRelativeAddress)
			e.PostInterrupt(i)
			return false
		} else {
