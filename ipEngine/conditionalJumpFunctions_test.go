...
var doubleJumpZeroExtendedMode = []*tasm.SourceItem{
	...
	dataSourceItem([]uint64{pkg.PositiveZero}),
	dataSourceItem([]uint64{pkg.PositiveZero}),

	labelSourceItem("negZero"),
	dataSourceItem([]uint64{pkg.NegativeZero}),
	dataSourceItem([]uint64{pkg.NegativeZero}),

	labelSourceItem("notZero1"),
	dataSourceItem([]uint64{pkg.PositiveZero}),
	dataSourceItem([]uint64{pkg.PositiveOne}),
	...
	segSourceItem(0),
	dlSourceItemHIBRef(regA0, 0, 0, 0, pkg.B3, "posZero"),
	djzSourceItemRef(regA0, "target1"),
	iarSourceItem(1),

	labelSourceItem("target1"),
	dlSourceItemHIBRef(regA2, 0, 0, 0, pkg.B3, "negZero"),
	djzSourceItemRef(regA2, "target2"),
	iarSourceItem(2),

	labelSourceItem("target2"),
	dlSourceItemHIBRef(regA4, 0, 0, 0, pkg.B3, "notZero1"),
	djzSourceItemRef(regA4, "bad3"),

	labelSourceItem("target3"),
	dlSourceItemHIBRef(regA6, 0, 0, 0, pkg.B3, "notZero2"),
