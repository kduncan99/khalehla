...
var partialWordStoresExtendedThirdWord = []*tasm.SourceItem{
	...
	segSourceItem(0),
	laSourceItemHIBRef(jW, regA0, 0, 0, 0, pkg.B2, "data1"),
	lxiSourceItemU(jU, regX1, 0, 1),
	lxmSourceItemU(jU, regX1, 0, 0),
	saSourceItemHIBRef(jW, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jH1, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jH2, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jXH1, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jXH2, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jT1, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jT2, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jT3, regA0, regX1, 1, 0, pkg.B2, "data2"),
	iarSourceItem(0),
}
...
var partialWordStoresExtendedQuarterWord = []*tasm.SourceItem{
	...
	lxmSourceItemU(jU, regX1, 0, 0),
	laSourceItemHIBRef(jW, regA0, 0, 0, 0, pkg.B2, "data1"),
	saSourceItemHIBRef(jQ1, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jQ2, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jQ3, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jQ4, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jS1, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jS2, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jS3, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jS4, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jS5, regA0, regX1, 1, 0, pkg.B2, "data2"),
	saSourceItemHIBRef(jS6, regA0, regX1, 1, 0, pkg.B2, "data2"),
	iarSourceItem(0),
}
...
var grsAddressingExtended = []*tasm.SourceItem{
	...
	laSourceItemU(jW, regA5, 0, pkg.X5),
	laSourceItemU(jS3, regA6, 0, pkg.X5), // partial word ignored, we're register-to-register
	iarSourceItem(0),
}
