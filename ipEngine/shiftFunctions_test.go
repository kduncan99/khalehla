...
func Test_SSC(t *testing.T) {
	...
	checkRegister(t, engine, pkg.A0, 0_112233_445566)
	checkRegister(t, engine, pkg.A1, 0_112233_445566)
	checkRegister(t, engine, pkg.A2, 0_112233_445566)
	checkRegister(t, engine, pkg.A3, 0_445566_112233)
	checkRegister(t, engine, pkg.A4, 0_045115_622673)
	checkRegister(t, engine, pkg.A5, 0_224467_113354)
	checkRegister(t, engine, pkg.A6, 0_661122_334455)
}
...
func Test_SSL(t *testing.T) {
	...
	checkStoppedReason(t, engine, InitiateAutoRecoveryStop, 0)
	checkRegister(t, engine, pkg.A0, 0_112233_445566)
	checkRegister(t, engine, pkg.A1, 0)
	checkRegister(t, engine, pkg.A2, 0)
	checkRegister(t, engine, pkg.A3, 0_112233)
	checkRegister(t, engine, pkg.A4, 0_266666_666666)
	checkRegister(t, engine, pkg.A5, 01)
	checkRegister(t, engine, pkg.A6, 0_044444_733333)
	checkRegister(t, engine, pkg.A7, 0)
}
...
func Test_LSSC(t *testing.T) {
	...
	checkRegister(t, engine, pkg.A2, 0_112233_445566)
	checkRegister(t, engine, pkg.A3, 0_445566_112233)
	checkRegister(t, engine, pkg.A4, 0_224467_113354)
	checkRegister(t, engine, pkg.A5, 0_045115_622673)
	checkRegister(t, engine, pkg.A6, 0_223344_556611)
}
