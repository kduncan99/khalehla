...
func StoreAccumulator(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreASCIISpaces(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreASCIIZeroes(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreFieldataSpaces(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreFieldataZeroes(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreIndexRegister(e *InstructionEngine) (completed bool, interrupt Interrupt) {
	ci := e.GetCurrentInstruction()
...
func StoreNegativeOne(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreNegativeZero(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StorePositiveOne(e *InstructionEngine) (completed bool, interrupt Interrupt) {
...
func StoreRegister(e *InstructionEngine) (completed bool, interrupt Interrupt) {
	ci := e.GetCurrentInstruction()
...
func StoreZero(e *InstructionEngine) (completed bool, interrupt Interrupt) {
