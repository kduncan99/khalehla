...
func importTemplates() map[FacStatusCode]*FacStatusMessageTemplate {
	...
	importErrorTemplate(result, FacStatusIllegalInitialReserve, "Illegal value specified for initial reserve.")
	importErrorTemplate(result, FacStatusIllegalMaxGranules, "Illegal value specified for maximum.")
	...
	importErrorTemplate(result, FacStatusIncorrectReadKey, "Incorrect read key.")
	importErrorTemplate(result, FacStatusIncorrectWriteKey, "Incorrect write key.")
	importErrorTemplate(result, FacStatusMaximumIsLessThanInitialReserve, "Maximum is less than the initial reserve.")
	...
	importErrorTemplate(result, FacStatusReadWriteKeysNeeded, "Read and/or write keys are needed.")
	importErrorTemplate(result, FacStatusRelativeFCycleConflict, "Relative F-cycle conflict.")
