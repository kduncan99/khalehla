...
W:121233 File cannot be deleted because it is on the print queue. W:121333 A read key exists on the file.
...
W:122033 Security clearance level allows read only access. W:122133 File was assigned during system failure.
...
E:243633 Length of image submitted to ER CSI$ is bad. E:243733 Illegal control statement type submitted to ER CSI$.
...
E:255133  Facility inventory internal error - Security packet error.
...
This message is returned with any attempt to allocate a shared file into memory. This error can occur on a subsequent assignment of an existing shared file requesting a switch to a memory file assign mnemonic, as well as to the normal initial assignment.
E:267133  Media manager is not loaded.
A Media Manager specification was supplied on the @ASG statement, but the Media Manager is not loaded.
E:267233  Bypass of Media Manager is not allowed.
The Media Manager spec is not configured to allow bypass because you specified BYPASS in the mmspec field of the @ASG statement.
...
This message is received when the requestor attempts to assign a shared file without having at least one privilege to do so.
