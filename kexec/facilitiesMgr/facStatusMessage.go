...
func importTemplates() map[kexec.FacStatusCode]*FacStatusMessageTemplate {
	...
	importErrorTemplate(result, kexec.FacStatusHoldForReelRejected, "Hold for reel rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForPackRejected, "Hold for pack rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForTapeUnitRejected, "Hold for tape unit rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForDiskUnitRejected, "Hold for disk unit rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForXUseRejected, "Hold for x-use rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForReleaseXUseRejected, "Hold for release of x--use rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForRollbackRejected, "Hold for rollback of unloaded file rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForRemDiskRejected, "Hold for *rem disk rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForDevCURejected, "Hold for *DEV/CU rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForFCycleConflictRejected, "Hold for F-cycle conflict rejected because of Z option.")
	importErrorTemplate(result, kexec.FacStatusHoldForMassStorageSpaceRejected, "Hold for mass storage space rejected because of Z option.")
