...
type ICatalogedFileFacilitiesItem interface {
	GetMainItem0Address() kexec2.MFDRelativeAddress
...
type IDiskFileFacilitiesItem interface {
	GetFileAllocationSet() *kexec2.FileAllocationSet
	IsSectorAddressable() bool
	IsWordAddressable() bool
	TranslateTrackId(fileTrackId hardware.TrackId) (ldat kexec2.LDATIndex, deviceTrackId hardware.TrackId)
}
...
type TemporaryFixedDiskFileFacilitiesItem struct {
	fileAllocations kexec2.FileAllocationSet
}
