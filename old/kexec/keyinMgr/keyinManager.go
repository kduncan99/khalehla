...
var handlerTable = map[string]func(kexec.IExec, kexec2.ConsoleIdentifier, string, string) IKeyinHandler{
	"$!": NewStopKeyinHandler,
	// "AP"
	// "AT"
	// "B"
...
func (mgr *KeyinManager) PostKeyin(source kexec2.ConsoleIdentifier, text string) {
	mgr.mutex.Lock()
