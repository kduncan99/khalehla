...
func (reg *BaseRegister) FromBankDescriptor(bd *BankDescriptor, storage []types.Word36) *BaseRegister {
...
func (reg *BaseRegister) FromBankDescriptorWithSubsetting(bd *BankDescriptor, offset uint, storage []types.Word36) {
	reg.accessLock = bd.accessLock
	reg.baseAddress = bd.baseAddress
...
func NewBaseRegisterFromBuffer(buffer []types.Word36, storage []types.Word36) *BaseRegister {
